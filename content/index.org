...
- 11 slash commands for common workflows (explain, review, test, git, etc.)
- 4 agent skills for autonomous capabilities (TypeScript types, test coverage, Emacs integration, documentation)
- MCP server integrations (Emacs, filesystem)
- All configs with detailed inline documentation
...
| [[*Development Tools][Development Tools]] |           7 modules | AI assistant and tool configurations |
