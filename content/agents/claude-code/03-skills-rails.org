#+TITLE: Agent Skills - Rails Development
...
#+begin_src markdown :tangle ~/.claude/skills/rails-conventions/SKILL.md
---
...
#+begin_src markdown :tangle ~/.claude/skills/rails-security/SKILL.md
---
...
This skill extends the generic [[*Test Coverage Analyzer][Test Coverage Analyzer]] with Rails-specific patterns.
...
#+begin_src markdown :tangle ~/.claude/skills/rails-migrations/SKILL.md
  ---
