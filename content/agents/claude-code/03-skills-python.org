#+TITLE: Agent Skills - Python Development
...
#+begin_src markdown :tangle ~/.claude/skills/python-conventions/SKILL.md
---
...
#+begin_src markdown :tangle ~/.claude/skills/python-security/SKILL.md
---
