...
User-invoked commands accessed by typing =/= in Claude Code. Includes documentation, code review, testing, and git workflow commands.

** [[file:03-skills.org][Agent Skills]]
Model-invoked capabilities for autonomous assistance

Skills that Claude automatically activates based on context. Includes TypeScript type generation, test coverage analysis, Emacs integration, and documentation checking.
...
- [[file:../../neovim/01-init.org][Neovim Configurations]] - Alternative editor setup
