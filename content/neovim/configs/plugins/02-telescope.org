...
#+DATE: 2025-12-01
#+PROPERTY: header-args:lua :tangle ~/.config/nvim/lua/pengling/plugins/telescope.lua :mkdirp yes

* Overview

Telescope is a highly extendable fuzzy finder for Neovim, providing fast file navigation, grep search, and LSP integration.
...
- =<leader>fg= - Live grep search through files
- =<leader>fb= / =<leader>bb= - Browse open buffers

** Help and Documentation
- =<leader>fh= - Search help tags
- =<leader>fc= - Browse available commands

** Navigation Aids
- =<leader>fm= - Browse marks
- =<leader>fp= - Browse registers

** LSP Integration
- =<leader>fs= - Find symbols in current document
...
- =<leader>fe= - Browse diagnostics/errors

** Custom Mappings
- =<C-g>= - Close telescope window (both insert and normal mode)
